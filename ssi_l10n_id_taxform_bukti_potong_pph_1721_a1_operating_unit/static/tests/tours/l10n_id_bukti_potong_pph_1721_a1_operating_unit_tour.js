...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_1721_a1_operating_unit" +
        ".l10n_id_bukti_potong_pph_1721_a1_operating_unit_tour",
    function (require) {
        "use strict";

        var tour = require("web_tour.tour");

        // ── IK: docs/l10n_id_bukti_potong_pph_1721_a1/01-create.md (E1
        // delta -- Additional Fields). Navigation (open menu -> New) is
        // taken from the base IK
        // ssi_l10n_id_taxform_bukti_potong_pph_1721_a1/docs/
        // l10n_id_bukti_potong_pph_1721_a1/01-create.md Flow steps 1-2 --
        // see scope-and-boundaries.md skill odoo-development-ui-test §1
        // ("Backing dua-file: tour extension = base IK ∪ delta IK"). The
        // delta assertions come from this module's own IK: the Operating
        // Unit field is visible AND editable on the create form for a
        // user in the operating_unit.group_multi_operating_unit group.
        // The tour stops there; it does not fill, save or confirm (E1
        // delta-only).
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_1721_a1_operating_unit" +
                "_l10n_id_bukti_potong_pph_1721_a1_create",
            {test: true, url: "/web"},
            [
                // ── Base Flow 1 — Open the Taxform > Bukti Potong > Tax
                // Form 1721 A1 menu.
