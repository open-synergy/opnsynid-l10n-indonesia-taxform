...
class TestUiL10nIdBuktiPotongPph1721A1OperatingUnit(HttpSavepointCase):
    """UI/UX tour test for the Operating Unit field this module adds to
    ``l10n_id.bukti_potong_pph_1721_a1`` (E1 delta -- Additional
    Fields).

    Pairs with IK ``docs/l10n_id_bukti_potong_pph_1721_a1/01-create.md``
    (delta), backed by the base IK
    ``ssi_l10n_id_taxform_bukti_potong_pph_1721_a1/docs/
    l10n_id_bukti_potong_pph_1721_a1/01-create.md`` for the navigation
    up to the New button.
    """
    ...
    def setUpClass(cls):
        ...
        cls.operating_unit_partner = cls.env["res.partner"].create(
            {"name": "TOUR Bukti Potong 1721A1 OU Partner"}
        )
        cls.operating_unit = cls.env["operating.unit"].create(
            {
                "name": "TOUR Bukti Potong 1721A1 Operating Unit",
                "code": "TBP1721AOU",
