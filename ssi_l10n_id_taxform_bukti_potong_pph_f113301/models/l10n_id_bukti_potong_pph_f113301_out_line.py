...
class L10nIdBuktiPotongPphF113301OutLine(models.Model):
    """Detail line of a Bukti Potong PPh f.1.1.33.01 Out document.
    ...
    _description = "Bukti Potong PPh 21/26 f.1.1.33.01 Out Line"

    bukti_potong_id = fields.Many2one(
        comodel_name="l10n_id.bukti_potong_pph_f113301_out",
    )
    income_move_line_ids = fields.Many2many(
        relation="rel_bukpot_f113301_out_line_2_income_move",
