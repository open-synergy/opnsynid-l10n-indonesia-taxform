...
odoo.define(
    ...
    function (require) {
        ...
        // (f.1.1.33.01) Out (Flow step 1 of every IK in this file).
        var openMenuSteps = [
        ...
        tour.register(
            ...
            [].concat(
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113301"),
                selectMany2oneSteps("journal_id", "PPh 21/26 Out - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 21/26 Payable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113301"),
                selectMany2oneSteps("wajib_pajak_id", "TOUR WP CreateF113301"),
                selectMany2oneSteps("ttd_id", "TOUR TTD F113301"),
                // ── Flow 5 — Click Save.
                saveSteps,
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='wajib_pajak_id']:contains(TOUR WP CreateF113301)",
                        run: function () {
                            // Assertion only.
                        },
                    },
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113301_" +
                "l10n_id_bukti_potong_pph_f113301_out_confirm",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to confirm.
                openRecordSteps("TOUR WP ConfirmF113301"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113301_" +
                "l10n_id_bukti_potong_pph_f113301_out_approve",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to approve.
                openRecordSteps("TOUR WP ApproveF113301"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113301_" +
                "l10n_id_bukti_potong_pph_f113301_out_cancel",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to cancel.
                openRecordSteps("TOUR WP CancelF113301"),
                ...
                [
                    ...
                    // ── Flow 4 — Select the Cancellation Reason.
                    {
                        ...
                        trigger:
                            ".o_field_widget[name='cancel_reason_id'] label:contains(TOUR Cancel Reason F113301)",
                    },
