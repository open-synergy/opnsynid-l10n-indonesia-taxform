...
class TestUiL10nIdBuktiPotongPphF113301Out(HttpSavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.tax = cls.env.ref("ssi_l10n_id_taxform_bukti_potong_pph_f113301.demo_tax1")
        cls.expense_account = cls.env["account.account"].create(
            {
                "name": "TOUR Expense F113301",
                "code": "XTOURF113301EXP",
        ...
        cls.env["l10n_id.bukti_potong_pph_f113301_out_line"].create(
            {
        ...
        move = cls.env["account.move"].create(
            {
                ...
                "line_ids": [
                    ...
                    (
                        ...
                        0,
                        {
                            "name": "TOUR Income Line F113301 Contra",
