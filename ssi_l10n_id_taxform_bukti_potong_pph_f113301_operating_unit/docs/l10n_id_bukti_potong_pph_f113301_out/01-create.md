...
> **Module:** `ssi_l10n_id_taxform_bukti_potong_pph_f113301_operating_unit`\
> **Extends:** `ssi_l10n_id_taxform_bukti_potong_pph_f113301` — model `l10n_id.bukti_potong_pph_f113301_out`,
> aksi `01-create`
...
- The Bukti Potong PPh f.1.1.33.01 Out list is now filtered by operating unit (record
