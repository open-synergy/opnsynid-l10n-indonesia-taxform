...
class TestUiL10nIdBuktiPotongPphF113301OutOperatingUnit(HttpSavepointCase):
    """UI/UX tour test for the Operating Unit field this module adds to
    ``l10n_id.bukti_potong_pph_f113301_out`` (E1 delta -- Additional
    Fields).

    Pairs with IK ``docs/l10n_id_bukti_potong_pph_f113301_out/
    01-create.md`` (delta), backed by the base IK
    ``ssi_l10n_id_taxform_bukti_potong_pph_f113301/docs/
    l10n_id_bukti_potong_pph_f113301_out/01-create.md`` for the
    ...
    def setUpClass(cls):
        ...
        cls.operating_unit_partner = cls.env["res.partner"].create(
            {"name": "TOUR Bukti Potong F113301 OU Partner"}
        )
        cls.operating_unit = cls.env["operating.unit"].create(
            {
                "name": "TOUR Bukti Potong F113301 Operating Unit",
                "code": "TBP33OU",
    ...
    def test_field_operating_unit(self):
        ...
        self.start_tour(
            "/web",
            "ssi_l10n_id_taxform_bukti_potong_pph_f113301_operating_unit"
            "_l10n_id_bukti_potong_pph_f113301_out_create",
            login="admin",
        )
