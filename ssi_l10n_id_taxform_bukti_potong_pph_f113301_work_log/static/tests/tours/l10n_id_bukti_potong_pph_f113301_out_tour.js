...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113301_work_log." +
    ...
    function (require) {
        ...
        // ssi_l10n_id_taxform_bukti_potong_pph_f113301/docs/
        // l10n_id_bukti_potong_pph_f113301_out/01-create.md Flow
        ...
        tour.register(
            ...
            [].concat(
                ...
                // PPh 21/26 Tidak Final (f.1.1.33.01) Out menu.
                [
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113301WL"),
                selectMany2oneSteps("journal_id", "PPh 21/26 Out - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 21/26 Payable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113301WL"),
                selectMany2oneSteps("wajib_pajak_id", "TOUR WP CreateF113301WL"),
                selectMany2oneSteps("ttd_id", "TOUR TTD F113301WL"),
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='wajib_pajak_id']:contains(TOUR WP CreateF113301WL)",
                        run: function () {
                            // Assertion only.
                        },
                    },
