...
> **Module:** `ssi_l10n_id_taxform_bukti_potong_pph_f113302`\
> **Model:** `l10n_id.bukti_potong_pph_f113302_out`\
> **Menu:** Taxform > Bukti Potong > PPh 21 Final (f.1.1.33.02) Out\
> **Actor:** user in group `Bukti Potong PPh 21 Final F.1.1.33.02 Out / User`\
> **State:** `—` → `draft`
...
- **Data:** The accounting **Journal** and PPh payable **Account** already exist.
- **Data:** The **KPP** (tax office, `res.partner`, a company) already exists.
- **Data:** The **Wajib Pajak** (taxpayer, `res.partner`) already exists.
- **Data:** The **Pemotong Pajak** (withholding company, `res.partner`, normally the
  current company's partner) already exists.
- **Access:** User is in group `Bukti Potong PPh 21 Final F.1.1.33.02 Out / User`.

## Flow

1. Open the **Taxform > Bukti Potong > PPh 21 Final (f.1.1.33.02) Out** menu.
...
3. Fill in the required fields:
   ...
   - **Account** _(required)_: Select the PPh payable account.
   - **KPP** _(required)_: Select the tax office (KPP) partner.
   - **Wajib Pajak** _(required)_: Select the taxpayer being withheld from.
   - **Pemotong Pajak**: Automatically filled from the current company's partner
     (read-only, since this document's Type is "Out").
   - **TTD** _(required)_: Select the signer, a contact of the Pemotong Pajak.
