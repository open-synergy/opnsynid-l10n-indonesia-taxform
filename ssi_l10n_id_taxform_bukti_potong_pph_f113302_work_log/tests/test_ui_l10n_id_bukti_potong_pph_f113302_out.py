...
class TestUiL10nIdBuktiPotongPphF113302Out(HttpSavepointCase):
    ...
    def setUpClass(cls):
        ...
        create tour (see
        ``ssi_l10n_id_taxform_bukti_potong_pph_f113302``'s
        ``test_ui_l10n_id_bukti_potong_pph_f113302_out.py``), reusing
        ...
        cls.tax_period = cls.env["l10n_id.tax_period"].create(
            {
                "name": "TOUR 06/2026 F113302WL",
                "code": "TOUR-06/2026-F113302WL",
        ...
        cls.wajib_pajak = cls.env["res.partner"].create(
            {
                "name": "TOUR WP CreateF113302WL",
                "is_company": False,
            }
        )

    def test_create(self):
        """Run the create tour for the f.1.1.33.02 Out model.
