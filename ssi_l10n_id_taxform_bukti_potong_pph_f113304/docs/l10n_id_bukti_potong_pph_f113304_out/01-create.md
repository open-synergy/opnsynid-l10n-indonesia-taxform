# Create Bukti Potong PPh f.1.1.33.04 Out
...
> **Actor:** user in group `Bukti Potong PPh 22 (f.1.1.33.04) Out / User`\
> **State:** `—` → `draft`
...
- **Access:** User is in group `Bukti Potong PPh 22 (f.1.1.33.04) Out / User`.
