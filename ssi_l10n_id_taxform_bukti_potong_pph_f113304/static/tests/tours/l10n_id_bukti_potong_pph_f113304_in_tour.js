...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113304." +
        "l10n_id_bukti_potong_pph_f113304_in_tour",
    function (require) {
        "use strict";
        ...
        var openMenuSteps = [
            ...
            {
                content: "Open the PPh 22 (f.1.1.33.04) In menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_l10n_id_taxform_bukti_potong_pph_f113304.bukti_potong_pph_22_in_menu"]',
            },
            {
                content: "PPh 22 (f.1.1.33.04) In list is displayed",
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304_" +
                "l10n_id_bukti_potong_pph_f113304_in_create",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113304 In"),
                selectMany2oneSteps("journal_id", "PPh 22 In - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 22 Receivable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113304 In"),
                selectMany2oneSteps("pemotong_pajak_id", "TOUR PP CreateF113304I"),
                // ── Flow 5 — Click Save.
                saveSteps,
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='pemotong_pajak_id']:contains(TOUR PP CreateF113304I)",
                        run: function () {
                            // Assertion only.
                        },
                    },
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304_" +
                "l10n_id_bukti_potong_pph_f113304_in_confirm",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to confirm.
                openRecordSteps("TOUR PP ConfirmF113304I"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304_" +
                "l10n_id_bukti_potong_pph_f113304_in_approve",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to approve.
                openRecordSteps("TOUR PP ApproveF113304I"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304_" +
                "l10n_id_bukti_potong_pph_f113304_in_cancel",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to cancel.
                openRecordSteps("TOUR PP CancelF113304I"),
                ...
                [
                    ...
                    // ── Flow 4 — Select the Cancellation Reason.
                    {
                        ...
                        trigger:
                            ".o_field_widget[name='cancel_reason_id'] label:contains(TOUR Cancel Reason F113304 In)",
                    },
