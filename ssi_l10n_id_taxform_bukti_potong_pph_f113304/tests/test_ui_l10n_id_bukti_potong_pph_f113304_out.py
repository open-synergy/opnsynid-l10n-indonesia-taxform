...
_TOUR_PREFIX = (
    ...
    "l10n_id_bukti_potong_pph_f113304_out_"
)


@tagged("post_install", "-at_install")
class TestUiL10nIdBuktiPotongPphF113304Out(HttpSavepointCase):
    """Tour tests for the ``l10n_id.bukti_potong_pph_f113304_out`` work
    instructions."""
    ...
    def setUpClass(cls):
        ...
        cls.journal = cls.env.ref(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304.demo_journal2"
        )
        cls.account = cls.env.ref(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304.demo_account3"
        )
        cls.tax = cls.env.ref("ssi_l10n_id_taxform_bukti_potong_pph_f113304.demo_tax2")
        cls.expense_account = cls.env["account.account"].create(
            {
                "name": "TOUR Expense F113304 Out",
                "code": "XTOURF113304OEXP",
        ...
        cls.tax_period = cls.env["l10n_id.tax_period"].create(
            {
                "name": "TOUR 06/2026 F113304 Out",
                "code": "TOUR-06/2026-F113304O",
        ...
        cls.ttd = cls.env["res.partner"].create(
            {
                "name": "TOUR TTD F113304 Out",
                "is_company": False,
                "parent_id": cls.company.partner_id.id,
            }
        )

        cls.wajib_pajak_create = cls._create_wajib_pajak("TOUR WP CreateF113304O")
        cls.wajib_pajak_confirm = cls._create_wajib_pajak("TOUR WP ConfirmF113304O")
        cls.wajib_pajak_approve = cls._create_wajib_pajak("TOUR WP ApproveF113304O")
        cls.wajib_pajak_cancel = cls._create_wajib_pajak("TOUR WP CancelF113304O")

        cls.cancel_reason = cls.env["base.cancel_reason"].create(
            {
                "name": "TOUR Cancel Reason F113304 Out",
                "code": "TOURXF113304O",
                "global_use": True,
            }
        )
        ...
        move = cls.env["account.move"].create(
            {
                ...
                "line_ids": [
                    (
                        ...
                        0,
                        {
                            "name": "TOUR Income Line F113304 Out",
                    ...
                    (
                        ...
                        0,
                        {
                            "name": "TOUR Income Line F113304 Out Contra",
    ...
    def _create_order(cls, wajib_pajak):
        """Create a draft Bukti Potong PPh f.1.1.33.04 Out document.
        ...
        :return: the created ``l10n_id.bukti_potong_pph_f113304_out``
            record
        """
        return cls.env["l10n_id.bukti_potong_pph_f113304_out"].create(
            {
    ...
    def test_create(self):
        """Run the create tour for Bukti Potong PPh f.1.1.33.04 Out.
    ...
    def test_confirm(self):
        """Run the confirm tour for Bukti Potong PPh f.1.1.33.04 Out.
    ...
    def test_cancel(self):
        """Run the cancel tour for Bukti Potong PPh f.1.1.33.04 Out.
