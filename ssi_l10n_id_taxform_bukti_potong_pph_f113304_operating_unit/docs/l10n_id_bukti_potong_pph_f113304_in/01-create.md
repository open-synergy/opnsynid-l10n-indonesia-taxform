# Create Bukti Potong PPh f.1.1.33.04 In

> **Module:** `ssi_l10n_id_taxform_bukti_potong_pph_f113304_operating_unit`\
> **Extends:** `ssi_l10n_id_taxform_bukti_potong_pph_f113304` — model `l10n_id.bukti_potong_pph_f113304_in`,
> aksi `01-create`
...
- The Bukti Potong PPh f.1.1.33.04 In list is now filtered by operating unit (record
