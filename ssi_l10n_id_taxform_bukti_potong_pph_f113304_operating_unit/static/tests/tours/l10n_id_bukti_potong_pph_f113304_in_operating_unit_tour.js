...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113304_operating_unit" +
        ".l10n_id_bukti_potong_pph_f113304_in_operating_unit_tour",
    function (require) {
        "use strict";
        ...
        // l10n_id_bukti_potong_pph_f113304_in/01-create.md Flow steps
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113304_operating_unit" +
                "_l10n_id_bukti_potong_pph_f113304_in_create",
            {test: true, url: "/web"},
            [
                // ── Base Flow 1 — Open the Taxform > Bukti Potong >
                // PPh 22 (f.1.1.33.04) In menu.
                ...
                },
                {
                    ...
                    trigger:
                        ".o_control_panel .breadcrumb-item.active:contains(PPh 22)",
