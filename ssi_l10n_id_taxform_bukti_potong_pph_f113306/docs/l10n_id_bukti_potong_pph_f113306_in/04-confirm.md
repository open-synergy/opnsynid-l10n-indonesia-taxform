# Confirm Bukti Potong PPh f.1.1.33.06 In
...
> **Actor:** user in group `Bukti Potong PPh 23 (f.1.1.33.06) In / User`\
> **State:** `draft` → `confirm`\
> **Requires:** `01-create`
...
- **Access:** User is in group `Bukti Potong PPh 23 (f.1.1.33.06) In / User`.
