...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113306." +
        "l10n_id_bukti_potong_pph_f113306_in_tour",
    function (require) {
        "use strict";
        ...
        var openMenuSteps = [
            ...
            {
                content: "Open the PPh 23 (f.1.1.33.06) In menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_l10n_id_taxform_bukti_potong_pph_f113306.bukti_potong_pph_23_in_menu"]',
            },
            {
                content: "PPh 23 (f.1.1.33.06) In list is displayed",
                trigger: ".o_control_panel .breadcrumb-item.active:contains(PPh 23)",
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113306_" +
                "l10n_id_bukti_potong_pph_f113306_in_create",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113306 In"),
                selectMany2oneSteps("journal_id", "PPh 23 In - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 23 Receivable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113306 In"),
                selectMany2oneSteps("pemotong_pajak_id", "TOUR PP CreateF113306I"),
                // ── Flow 5 — Click Save.
                saveSteps,
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='pemotong_pajak_id']:contains(TOUR PP CreateF113306I)",
                        run: function () {
                            // Assertion only.
                        },
                    },
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113306_" +
                "l10n_id_bukti_potong_pph_f113306_in_confirm",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to confirm.
                openRecordSteps("TOUR PP ConfirmF113306I"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113306_" +
                "l10n_id_bukti_potong_pph_f113306_in_approve",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to approve.
                openRecordSteps("TOUR PP ApproveF113306I"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113306_" +
                "l10n_id_bukti_potong_pph_f113306_in_cancel",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to cancel.
                openRecordSteps("TOUR PP CancelF113306I"),
                ...
                [
                    ...
                    // ── Flow 4 — Select the Cancellation Reason.
                    {
                        ...
                        trigger:
                            ".o_field_widget[name='cancel_reason_id'] label:contains(TOUR Cancel Reason F113306 In)",
                    },
