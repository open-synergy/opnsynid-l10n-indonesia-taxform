...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113306_operating_unit" +
        ".l10n_id_bukti_potong_pph_f113306_in_operating_unit_tour",
    function (require) {
        "use strict";
        ...
        // ssi_l10n_id_taxform_bukti_potong_pph_f113306/docs/
        // l10n_id_bukti_potong_pph_f113306_in/01-create.md Flow steps
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113306_operating_unit" +
                "_l10n_id_bukti_potong_pph_f113306_in_create",
            {test: true, url: "/web"},
            [
                ...
                },
                {
                    ...
                    trigger:
                        ".o_control_panel .breadcrumb-item.active:contains(PPh 23)",
