...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113306_work_log.l10n_id_bukti_potong_pph_f113306_in_tour",
    function (require) {
        "use strict";
        ...
        // docs/l10n_id_bukti_potong_pph_f113306_in/01-create.md Flow
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113306_work_log_l10n_id_bukti_potong_pph_f113306_in_create",
            {
                test: true,
                url: "/web",
            },
            [
                ...
                {
                    content: "Bukti Potong PPh 23 (f.1.1.33.06) In list is displayed",
                    trigger:
                        '.o_control_panel .breadcrumb-item.active:contains("f.1.1.33.06) In")',
