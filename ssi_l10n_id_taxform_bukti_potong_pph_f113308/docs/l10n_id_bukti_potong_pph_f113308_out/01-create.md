# Create Bukti Potong PPh f.1.1.33.08 Out
...
> **Actor:** user in group `Bukti Potong PPh 26 (f.1.1.33.08) Out / User`\
> **State:** `—` → `draft`
...
- **Access:** User is in group `Bukti Potong PPh 26 (f.1.1.33.08) Out / User`.
...
3. Fill in the required fields:
   ...
   - **TTD**: Select the signer, a contact of the Pemotong Pajak.
