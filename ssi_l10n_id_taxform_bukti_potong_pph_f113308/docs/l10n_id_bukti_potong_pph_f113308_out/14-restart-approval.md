# Restart Approval Process — Bukti Potong PPh f.1.1.33.08 Out
...
> **Actor:** user in group `Bukti Potong PPh 26 (f.1.1.33.08) Out / Validator`\
...
- **Access:** User is in group `Bukti Potong PPh 26 (f.1.1.33.08) Out / Validator`.
