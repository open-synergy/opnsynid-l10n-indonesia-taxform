...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113308." +
        "l10n_id_bukti_potong_pph_f113308_out_tour",
    function (require) {
        "use strict";
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113308_" +
                "l10n_id_bukti_potong_pph_f113308_out_create",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113308 Out"),
                selectMany2oneSteps("journal_id", "PPh 26 Out - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 26 Payable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113308 Out"),
                selectMany2oneSteps("wajib_pajak_id", "TOUR WP CreateF113308O"),
                selectMany2oneSteps("ttd_id", "TOUR TTD F113308 Out"),
                // ── Flow 5 — Click Save.
                saveSteps,
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='wajib_pajak_id']:contains(TOUR WP CreateF113308O)",
                        run: function () {
                            // Assertion only.
                        },
                    },
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113308_" +
                "l10n_id_bukti_potong_pph_f113308_out_confirm",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to confirm.
                openRecordSteps("TOUR WP ConfirmF113308O"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113308_" +
                "l10n_id_bukti_potong_pph_f113308_out_approve",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to approve.
                openRecordSteps("TOUR WP ApproveF113308O"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113308_" +
                "l10n_id_bukti_potong_pph_f113308_out_cancel",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to cancel.
                openRecordSteps("TOUR WP CancelF113308O"),
                ...
                [
                    ...
                    // ── Flow 4 — Select the Cancellation Reason.
                    {
                        ...
                        trigger:
                            ".o_field_widget[name='cancel_reason_id'] label:contains(TOUR Cancel Reason F113308 Out)",
                    },
