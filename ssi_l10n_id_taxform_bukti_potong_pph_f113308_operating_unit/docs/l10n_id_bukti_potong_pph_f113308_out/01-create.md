...
> **Module:** `ssi_l10n_id_taxform_bukti_potong_pph_f113308_operating_unit`\
> **Extends:** `ssi_l10n_id_taxform_bukti_potong_pph_f113308` — model `l10n_id.bukti_potong_pph_f113308_out`,
> aksi `01-create`
...
- The Bukti Potong PPh f.1.1.33.08 Out list is now filtered by operating unit (record
