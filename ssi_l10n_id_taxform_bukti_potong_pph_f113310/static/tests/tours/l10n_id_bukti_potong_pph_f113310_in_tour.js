    ...
    function (require) {
        ...
        tour.register(
            ...
            [].concat(
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113310 In"),
                selectMany2oneSteps("journal_id", "PPh 4(2) In - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 4(2) Receivable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113310 In"),
                selectMany2oneSteps("pemotong_pajak_id", "TOUR PP CreateF113310I"),
                // ── Flow 5 — Click Save.
                saveSteps,
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='pemotong_pajak_id']:contains(TOUR PP CreateF113310I)",
                        run: function () {
                            // Assertion only.
                        },
                    },
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_in_confirm",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to confirm.
                openRecordSteps("TOUR PP ConfirmF113310I"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_in_approve",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_in_cancel",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
