...
odoo.define(
    "ssi_l10n_id_taxform_bukti_potong_pph_f113310." +
        "l10n_id_bukti_potong_pph_f113310_out_tour",
    function (require) {
        "use strict";
        ...
        var openMenuSteps = [
            ...
            {
                content: "Open the PPh 4(2) (f.1.1.33.10) Out menu",
                trigger:
                    '.o_menu_sections [data-menu-xmlid="ssi_l10n_id_taxform_bukti_potong_pph_f113310.bukti_potong_pph_42_out_menu"]',
            },
            {
                // NOTE: unlike f113306, this menu's label contains
                // literal parentheses ("PPh 4(2) ..."), which jQuery's
                // `:contains()` selector cannot match reliably (it
                // does not support nested parens). Match the
                // parenthesis-free form number instead.
                content: "PPh 4(2) (f.1.1.33.10) Out list is displayed",
                trigger:
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_out_create",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                ...
                selectMany2oneSteps("tax_period_id", "TOUR 06/2026 F113310 Out"),
                selectMany2oneSteps("journal_id", "PPh 4(2) Out - (test)"),
                selectMany2oneSteps(
                    "account_id",
                    "Art. 4(2) Payable No Taxform - (test)"
                ),
                selectMany2oneSteps("kpp_id", "TOUR KPP F113310 Out"),
                selectMany2oneSteps("wajib_pajak_id", "TOUR WP CreateF113310O"),
                selectMany2oneSteps("ttd_id", "TOUR TTD F113310 Out"),
                // ── Flow 5 — Click Save.
                saveSteps,
                ...
                [
                    {
                        ...
                        trigger:
                            ".o_form_readonly .o_field_widget[name='wajib_pajak_id']:contains(TOUR WP CreateF113310O)",
                        run: function () {
                            // Assertion only.
                        },
                    },
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_out_confirm",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to confirm.
                openRecordSteps("TOUR WP ConfirmF113310O"),
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_out_approve",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
        ...
        tour.register(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310_" +
                "l10n_id_bukti_potong_pph_f113310_out_cancel",
            {test: true, url: "/web"},
            [].concat(
                openMenuSteps,
                // ── Flow 2 — Open the record to cancel.
                openRecordSteps("TOUR WP CancelF113310O"),
                ...
                [
                    ...
                    // ── Flow 4 — Select the Cancellation Reason.
                    {
                        ...
                        trigger:
                            ".o_field_widget[name='cancel_reason_id'] label:contains(TOUR Cancel Reason F113310 Out)",
                    },
