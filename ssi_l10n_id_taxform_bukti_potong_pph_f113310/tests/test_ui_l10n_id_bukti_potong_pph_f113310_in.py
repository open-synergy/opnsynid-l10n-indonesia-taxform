...
_TOUR_PREFIX = (
    ...
    "l10n_id_bukti_potong_pph_f113310_in_"
)


@tagged("post_install", "-at_install")
class TestUiL10nIdBuktiPotongPphF113310In(HttpSavepointCase):
    """Tour tests for the ``l10n_id.bukti_potong_pph_f113310_in`` work
    instructions."""
    ...
    def setUpClass(cls):
        ...
        cls.journal = cls.env.ref(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310.demo_journal1"
        )
        cls.account = cls.env.ref(
            "ssi_l10n_id_taxform_bukti_potong_pph_f113310.demo_account1"
        )
        cls.tax = cls.env.ref("ssi_l10n_id_taxform_bukti_potong_pph_f113310.demo_tax1")
        cls.expense_account = cls.env["account.account"].create(
            {
                "name": "TOUR Expense F113310 In",
                "code": "XTOURF113310IEXP",
        ...
        cls.tax_period = cls.env["l10n_id.tax_period"].create(
            {
                "name": "TOUR 06/2026 F113310 In",
                "code": "TOUR-06/2026-F113310I",
        ...
        cls.kpp = cls.env["res.partner"].create(
            {
                "name": "TOUR KPP F113310 In",
                "is_company": True,
            }
        )

        cls.pemotong_pajak_create = cls._create_pemotong_pajak("TOUR PP CreateF113310I")
        cls.pemotong_pajak_confirm = cls._create_pemotong_pajak(
            "TOUR PP ConfirmF113310I"
        )
        cls.pemotong_pajak_approve = cls._create_pemotong_pajak(
            "TOUR PP ApproveF113310I"
        )
        cls.pemotong_pajak_cancel = cls._create_pemotong_pajak("TOUR PP CancelF113310I")
        ...
        cls.cancel_reason = cls.env["base.cancel_reason"].create(
            {
                "name": "TOUR Cancel Reason F113310 In",
                "code": "TOURXF113310I",
                "global_use": True,
            }
        )
        ...
        cls.env["l10n_id.bukti_potong_pph_f113310_in_line"].create(
            {
        ...
        move = cls.env["account.move"].create(
            {
                ...
                "line_ids": [
                    (
                        ...
                        0,
                        {
                            "name": "TOUR Income Line F113310 In",
                    ...
                    (
                        ...
                        0,
                        {
                            "name": "TOUR Income Line F113310 In Contra",
    ...
    def _create_order(cls, pemotong_pajak):
        """Create a draft Bukti Potong PPh f.1.1.33.10 In document.
        ...
        :param pemotong_pajak: the ``res.partner`` withholding party
            of the document
        :return: the created ``l10n_id.bukti_potong_pph_f113310_in``
            record
        """
        return cls.env["l10n_id.bukti_potong_pph_f113310_in"].create(
            {
    ...
    def test_create(self):
        """Run the create tour for Bukti Potong PPh f.1.1.33.10 In.
    ...
    def test_confirm(self):
        """Run the confirm tour for Bukti Potong PPh f.1.1.33.10 In.

        IK: docs/l10n_id_bukti_potong_pph_f113310_in/04-confirm.md
        """
        self.start_tour(
            "/web",
    ...
    def test_cancel(self):
        """Run the cancel tour for Bukti Potong PPh f.1.1.33.10 In.

        IK: docs/l10n_id_bukti_potong_pph_f113310_in/10-cancel.md
        """
        self.start_tour(
            "/web",
            _TOUR_PREFIX + "cancel",
