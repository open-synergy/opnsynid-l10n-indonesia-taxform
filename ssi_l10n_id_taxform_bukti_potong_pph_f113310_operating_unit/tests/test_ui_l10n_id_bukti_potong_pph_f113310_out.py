...
class TestUiL10nIdBuktiPotongPphF113310Out(HttpSavepointCase):
    ...
    def setUpClass(cls):
        ...
        operating_unit_partner = cls.env["res.partner"].create(
            {"name": "Tour F113310 Out OU Partner"}
        )
        cls.operating_unit = cls.env["operating.unit"].create(
            {
                "name": "Tour F113310 Out Operating Unit",
                "code": "TF113310OOU",
    ...
    def test_create(self):
        """Run the create tour for ``l10n_id.bukti_potong_pph_f113310_out``.

        IK: docs/l10n_id_bukti_potong_pph_f113310_out/01-create.md (E1
